...
const LoginScreen = () => {
  ...
  // Mostrar mensaje cuando viene de verify email
  useEffect(() => {
  ...
  return (
    <div className="Form-login-container">
      <form onSubmit={handleSubmit}>
        ...
        {response && response.ok && <span className="form-message form-message--success">Successful Login</span>}

        {loading
          ? <button className="auth-submit-btn" disabled>Logging in...</button>
